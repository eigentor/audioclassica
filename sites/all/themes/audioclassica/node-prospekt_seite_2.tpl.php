...
<?php if(isset($field_weitere_produktbilder[0]['filepath'])) { ?>
...
<?php if ($field_presseartikel_1_link[0]['value'] != '') { ?> 
...
<!-- <?php if ($field_presseartikel_2_bild[0]['filepath']) { ?>
  <th>&nbsp;</th>
  <?php };?> -->
  
  <?php if ($field_presseartikel_3_bild[0]['filepath']) { ?>
  <th>&nbsp;</th>
  <?php };?>
  
  <?php if ($field_presseartikel_4_bild[0]['filepath']) { ?>
  <th>&nbsp;</th>
  <?php };?>
  
  <?php if ($field_presseartikel_5_bild[0]['filepath']) { ?>
  <th>&nbsp;</th>
  <?php };?>
  
  <?php if ($field_presseartikel_6_bild[0]['filepath']) { ?>
  <th>&nbsp;</th>
  <?php };?>
  
  <?php if ($field_presseartikel_7_bild[0]['filepath']) { ?>
  <th>&nbsp;</th>
  <?php };?>
...
<?php if ($field_infomaterial_1_link[0]['value'] != '') { ?> 
...
<!-- <?php if ($field_infomaterial_2_bild[0]['filepath']) { ?>
  <th>&nbsp;</th>
  <?php };?> 
  ...
  <?php if ($field_infomaterial_3_bild[0]['filepath']) { ?>
  <th>&nbsp;</th>
  <?php };?>
  
  <?php if ($field_infomaterial_4_bild[0]['filepath']) { ?>
  <th>&nbsp;</th>
  <?php };?>
  
  <?php if ($field_infomaterial_5_bild[0]['filepath']) { ?>
  <th>&nbsp;</th>
  <?php };?>
